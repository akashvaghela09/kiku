...
[![Download](https://img.shields.io/badge/Download-v1.0.3-22A7CC?style=for-the-badge)](https://github.com/akashvaghela09/kiku/releases/latest)
...
```sh
chmod +x Kiku_1.0.3_amd64.AppImage
./Kiku_1.0.3_amd64.AppImage
```

Or install the Debian package:

```sh
sudo apt install ./Kiku_1.0.3_amd64.deb
```
